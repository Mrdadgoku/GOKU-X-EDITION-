...
❖ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ➥ [N𝗲𝘇𝘂𝗞𝗼 ✘ 𝘼𝙨𝙨𝙞𝙨𝙩𝙖𝙣𝙩™](https://t.me/NezukoxAssistant_bot)
""",
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(f"⦿ ᴀᴅᴅ ᴍᴇ ⦿", url=f"https://t.me/NezukoxAssistant_bot?startgroup=true")]])
        )
    except Exception as e:
        LOGGER.error(e)
    try:
